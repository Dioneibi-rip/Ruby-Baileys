...
export declare const extractDeviceJids: (result: USyncQueryResultList[], myJid: string, myLidOrExcludeZeroDevices?: string | boolean, excludeZeroDevices?: boolean) => JidWithDevice[];
/**
