...
function makeCacheableSignalKeyStore(store, logger, _cache) {
    const cache = _cache || new lru_cache_1.LRUCache({
        maxKeys: 2000,
        ttl: Defaults_1.DEFAULT_CACHE_TTLS.SIGNAL_STORE,
        cleanupIntervalMs: Defaults_1.DEFAULT_CACHE_TTLS.SIGNAL_STORE * 1000,
    });
