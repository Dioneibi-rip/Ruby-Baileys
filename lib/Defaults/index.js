...
const version = (baileys_version_json_1.default === null || baileys_version_json_1.default === void 0 ? void 0 : baileys_version_json_1.default.version) || [2, 3000, 1027934701];
...
exports.DEFAULT_MESSAGE_SAFETY_CONFIG = {
    enabled: true,
    messageSendMinDelayMs: 2000,
    messageSendMaxDelayMs: 8000,
    perJidMinDelayMs: 2500,
    warmUpMessageCount: 5,
    warmUpMinDelayMs: 3000,
    warmUpMaxDelayMs: 12000,
    presenceMinDelayMs: 1200,
    presenceMaxDelayMs: 12000,
    presenceMsPerChar: 65,
    mediaPresenceMaxDelayMs: 6500,
    presencePauseMinDelayMs: 250,
    presencePauseMaxDelayMs: 900,
