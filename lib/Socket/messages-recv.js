...
const makeMessagesRecvSocket = (config) => {
            ...
            await Promise.all([
                notificationMutex.mutex(async () => {
                    ...
                    if (msg) {
                        ...
                        fullMsg.key = normalizeLegacyKey(fullMsg.key)
    ...
    const handleMessage = async (node) => {
        ...
        console.log('[DEBUG-SOCKET] Mensaje crudo recibido:', { from: node.attrs.from, id: node.attrs.id, participant: node.attrs.participant, offline: node.attrs.offline });
        ...
        try {
            await messageMutex.mutex(async () => {
                ...
                msg.key = normalizeLegacyKey(msg.key)
