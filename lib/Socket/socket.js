...
const rubyLog = {
    ...
    printBanner() {
        ...
        console.log(paint(RUBY_ASCII.join("\n")))
        console.log(paint("[RUBY-CORE] Framework iniciado: rápido, estable y humanizado\n"))
    },
    connected() {
        this.printBanner()
        console.log(paint("[RUBY-CORE] ✅ Conexión establecida"))
    },
    disconnected(reason) {
        console.log(paint(`[RUBY-CORE] ❌ Conexión cerrada${reason ? ` (${reason})` : ""}`))
    },
    incomingMessage() {
        console.log(paint("[RUBY-CORE] ✉️ Nuevo mensaje recibido"))
    }
}
