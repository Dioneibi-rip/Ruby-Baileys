...
const rubyLog = {
    ...
    printBanner() {
        ...
        console.log(chalk.magentaBright(RUBY_ASCII.join("\n")))
        console.log(chalk.cyan("[RUBY-CORE] Framework iniciado: rápido, estable y humanizado\n"))
    },
    connected() {
        this.printBanner()
        console.log(chalk.green("[RUBY-CORE] ✅ Conexión establecida"))
    },
    disconnected(reason) {
        console.log(chalk.red(`[RUBY-CORE] ❌ Conexión cerrada${reason ? ` (${reason})` : ""}`))
    },
    incomingMessage() {
        console.log(chalk.yellow("[RUBY-CORE] ✉️ Nuevo mensaje recibido"))
    }
}
...
const makeSocket = (config) => {
   ...
   /** ephemeral key pair used to encrypt/decrypt communication. Unique for each connection */
    ...
    const end = (error) => {
        ...
        rubyLog.disconnected(error?.output?.statusCode || error?.message)
