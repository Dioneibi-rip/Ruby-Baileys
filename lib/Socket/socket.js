...
const makeSocket = (config) => {
    ...
    if (!sanitizedPhoneNumber) {
        throw new boom_1.Boom('Invalid phone number for pairing code request', { statusCode: 400 })
    }
    ...
    authState.creds.pairingCode = pairingCode || 'RUBYCHAN'

    authState.creds.me = {
        id: WABinary_1.jidEncode(sanitizedPhoneNumber, 's.whatsapp.net'),
        name: '~'
    }
