...
const makeSocket = (config) => {
    ...
    // ==== OPTIMIZACIÓN: Anti-crash en listeners ====
    // Evita advertencias de memoria en Node si el bot tiene muchos eventos
    ...
    // ==== OPTIMIZACIÓN: Keep Alive Robusto ====
    const startKeepAliveRequest = () => (keepAliveReq = setInterval(() => {
        ...
        // Tolerancia aumentada para redes lentas (Intervalo + 10 segundos)
        const safeTimeout = keepAliveIntervalMs + 10000;
    ...
    ws.on('CB:ib,,offline', (node) => {
        ...
        if (didStartBuffer) {
            // OPTIMIZACIÓN: Flush asíncrono para no trabar el loop
            process.nextTick(() => {
                ev.flush();
    ...
    // ==== LÓGICA DE ACTUALIZACIÓN DE CREDS (Final) ====
