...
exports.lidToJid = exports.getBotJid = exports.jidNormalizedUser = exports.transferDevice = exports.isJidBot = exports.isHostedLidUser = exports.isHostedPnUser = exports.isJidStatusBroadcast = exports.isJidGroup = exports.isJidNewsletter = exports.isJidBroadcast = exports.isLidUser = exports.isPnUser = exports.isJidUser = exports.isJidMetaAI = exports.isJidMetaAi = exports.areJidsSameUser = exports.jidDecode = exports.jidEncode = exports.META_AI_JID = exports.STORIES_JID = exports.PSA_WID = exports.SERVER_JID = exports.OFFICIAL_BIZ_JID = exports.S_WHATSAPP_NET = void 0;
...
const isHostedPnUser = (jid) => (jid === null || jid === void 0 ? void 0 : jid.endsWith('@hosted') || jid.endsWith('@hosted.s.whatsapp.net'));
...
const transferDevice = (fromJid, toJid) => {
    ...
    const toDecoded = (0, exports.jidDecode)(toJid);
    if (!toDecoded) return toJid;
    return (0, exports.jidEncode)(toDecoded.user, toDecoded.server, (fromDecoded === null || fromDecoded === void 0 ? void 0 : fromDecoded.device) || 0);
};
